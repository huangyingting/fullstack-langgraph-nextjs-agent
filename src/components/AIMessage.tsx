...
export const AIMessage = ({
  ...
  return (
    <div className="-mx-6 bg-[#F9F9F8] px-6 py-2">
        ...
        {messageContent && (
          <div className="not-prose max-w-none">
            <div
              ...
              className="text-[13px] leading-relaxed text-[#2D2D2D] [&_hr]:!my-0 [&_hr]:border-black/10 [&_li]:my-0 [&_ol]:ml-5 [&_ol]:list-decimal [&_ul]:ml-5 [&_ul]:list-disc [&_a]:text-[#AB6B3C] [&_a]:underline [&_a]:decoration-[#AB6B3C]/30 [&_a]:underline-offset-2 hover:[&_a]:decoration-[#AB6B3C] [&_code]:bg-black/5 [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:rounded [&_code]:text-[12px] [&_code]:font-mono [&_code]:text-[#2D2D2D] [&_pre]:bg-[#2D2D2D] [&_pre]:text-white [&_pre]:p-4 [&_pre]:rounded-lg [&_pre]:overflow-x-auto [&_pre_code]:bg-transparent [&_pre_code]:p-0 [&_pre_code]:text-white [&_h1]:text-[18px] [&_h1]:font-semibold [&_h1]:mt-1.5 [&_h1]:mb-0 [&_h2]:text-[16px] [&_h2]:font-semibold [&_h2]:mt-1 [&_h2]:mb-0 [&_h3]:text-[14px] [&_h3]:font-semibold [&_h3]:mt-1 [&_h3]:mb-0 [&_p]:!m-0 [&_strong]:font-semibold"
            >
              <MDEditor.Markdown
